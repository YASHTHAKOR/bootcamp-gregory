...
contract('Token', ([deployer, receiver, exchange]) => {
    ...
    describe('approving tokens', () => {
        ...
        describe('success', () => {
            ...
            it('emits an approval events', async () => {
                ...
                events.owner.toString().should.equal(deployer, 'owner is correct');
                events.spender.should.equal(exchange, 'Spender is correct');
    ...
    describe('delegated token balances', () => {
        ...
        describe('failure', async () => {
            ...
            //   transfer too many tokens
                let invalidAmount = tokens(100000000);
                await token.transferFrom(deployer, receiver, invalidAmount, {from: exchange}).should.be.rejectedWith(EVM_MESSAGE);
            });
